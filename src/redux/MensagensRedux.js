...
const messageSlice = createSlice({
  ...
  {
    builder
      .addCase(buscarMensagens.fulfilled, (state, action) => { return action.payload;})
      .addCase(enviarMensagem.fulfilled, (state, action) => { state.push(action.payload);})
      ...
      .addCase(excluirMensagem.fulfilled, (state, action) => { return state.filter((message) => message.id !== action.payload.id);});
  },
});
